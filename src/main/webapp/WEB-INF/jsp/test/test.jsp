...
<head>
    ...
    <link href="${pageContext.request.contextPath}/test/main.css" rel="stylesheet" type="text/css" />
    <link href="${pageContext.request.contextPath}/test/iconfont.css" rel="stylesheet" type="text/css" />
    <link href="${pageContext.request.contextPath}/test/test.css" rel="stylesheet" type="text/css" />
...
<script src="${pageContext.request.contextPath}/test/jquery-1.11.3.min.js"></script>
<script src="${pageContext.request.contextPath}/test/jquery.easy-pie-chart.js"></script>
<!--时间js-->
<script src="${pageContext.request.contextPath}/test/time/jquery.countdown.js"></script>
<script>
