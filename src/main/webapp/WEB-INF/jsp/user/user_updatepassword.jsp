...
<div class=" clearfix">
 ...
 <br/>
 <h3 >&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 
 &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; <font color="red">密码修改</font></h3><br/>
 <div class="left_add">
    <form action="${pageContext.request.contextPath }/user/updatepassword" method="post" >
                <li class=" clearfix"><label class="label_name"><i>*</i>请输入原始密码</label>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; <input name="oldpassword" type="password" class="add_text" style="width:220px"/></li>
    <br/><br/>
            <li class=" clearfix"><label class="label_name"><i>*</i>请输入新的密码</label>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;  <input name="newpassword" type="password" class="add_text" style="width:220px"/></li>
             <br/><br/>   <li class=" clearfix"><label class="label_name"><i>*</i>请再次输入新的密码</label>&nbsp; <input name="new2password" type="password" class="add_text" style="width:220px"/></li>
    <br/><br/>
   <br/>
