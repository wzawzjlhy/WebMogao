...
<div class="header">
	<div class="container text-right">
		<a href="${pageContext.request.contextPath }/user/toRegister" ><i class="icon icon-home"></i> 我要注册</a>
		...
		<span class="fl"><a href="${pageContext.request.contextPath }/admin/tologin"><i class="icon icon-desktop"></i> 我是管理员</a></span>
	</div>
</div>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-xs-12">
			<h1>慕课平台管理系统</h1>
			<div class="login-box">
				<form action="${pageContext.request.contextPath }/user/login" method="post" id="frmLogin" class="form-horizontal">
					<h5 align="center"><font color="red">${error }	${message }</font></h5>
					<hr/>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<div class="input-group">
								...
								<div class="input-group-addon" style="padding: 0 10px 0 0;">
									<img id="checkCode" src="${pageContext.request.contextPath }/DrawImage" class="imgcode" alt="看不清,点击此处换一张"/>
									<a href="javascript:void(0);" class="fn_myReload">换一张</a>
								</div>
							</div>
						</div>
					</div>
