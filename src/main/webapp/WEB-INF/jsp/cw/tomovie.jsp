					...
					<c:forEach items="${ceList }" var="c"
						...
						<tr>
							...
							<td class="td-manage"><a
									href="${pageContext.request.contextPath}/cw/kmovie?cid=${c.cid}"
									title="观看视频" class="btn btn-xs btn-success">观看视频</a>
	...
	function funCs(cid,kg,cscore) {
        if (kg == 1) {
            ...
            layer.confirm('你将进行此课程在线测试，确定现在测试吗？', {
              ...
              window.location.href="${pageContext.request.contextPath}/cw/csonline"+cid;
            }, function(){
                layer.msg("你已取消在线测试");
            });
