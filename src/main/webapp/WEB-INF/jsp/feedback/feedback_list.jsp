			...
			<table class="table table-striped table-bordered table-hover"
				...
				<thead>
					<tr>
						...
						<th width="120px">反馈人联系号码</th>
						<th width="80px">反馈内容</th>
						<th width="70px">反馈时间</th>
			...
			<div class="border clearfix" style="margin-left: 35%;">
				<span class="l_f"><a href="javascript:ovid()"
					...
					第${pageBean.page_current }页/${pageBean.page_total }页 <c:if
						...
						<a
							href="${ pageContext.request.contextPath }/projectapplication/listbyPageforuser?page=1&size=5">首页</a>|
								<a
							href="${ pageContext.request.contextPath }/projectapplication/listbyPageforuser?size=5&page=${pageBean.page_current-1}">上一页</a>|
							
    </c:if> <c:if test="${pageBean.page_current!=pageBean.page_total}">
						<a
							href="${ pageContext.request.contextPath }/projectapplication/listbyPageforuser?size=5&page=${pageBean.page_current+1}">下一页</a>|
								<a
							href="${ pageContext.request.contextPath}/projectapplication/listbyPageforuser?size=5&page=${pageBean.page_total}">尾页</a>|
